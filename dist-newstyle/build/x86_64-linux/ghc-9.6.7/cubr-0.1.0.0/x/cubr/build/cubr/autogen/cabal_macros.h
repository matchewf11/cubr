...
/* package cubr-0.1.0.0 */
#ifndef VERSION_cubr
#define VERSION_cubr "0.1.0.0"
#endif /* VERSION_cubr */
#ifndef MIN_VERSION_cubr
#define MIN_VERSION_cubr(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cubr */
...
#define CURRENT_COMPONENT_ID "cubr-0.1.0.0-inplace-cubr"
